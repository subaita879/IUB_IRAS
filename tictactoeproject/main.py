...
def draw_status():
	...
	screen.fill((153, 85, 187), (0, 500, 500, 100))
...
def check_win():
	...
	for row in range(0, 3):
		if((board[row][0] == board[row][1] == board[row][2]) and (board[row][0] is not None)):
			winner = board[row][0]
			pg.draw.line(screen, (250, 0, 0),(0, (row + 1)*height / 3 - height / 6), (width, (row + 1)*height / 3 - height / 6),5)
			break
	...
	for col in range(0, 3):
		if((board[0][col] == board[1][col] == board[2][col]) and (board[0][col] is not None)):
			winner = board[0][col]
			pg.draw.line(screen, (250, 0, 0), ((col + 1) * width / 3 - width / 6, 0),((col + 1) * width / 3 - width / 6, height), 5)
			break
	...
	if (board[0][0] == board[1][1] == board[2][2]) and (board[0][0] is not None):
		...
		winner = board[0][0]
		pg.draw.line(screen, (250, 70, 70), (50, 50), (450, 450), 5)

	if (board[0][2] == board[1][1] == board[2][0]) and (board[0][2] is not None):

		# game won diagonally right to left
		winner = board[0][2]
		pg.draw.line(screen, (250, 70, 70), (450, 50), (50, 450), 5)
